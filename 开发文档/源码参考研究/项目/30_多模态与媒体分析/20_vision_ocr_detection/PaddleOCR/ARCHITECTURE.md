...
- **项目**：PaddleOCR
- **本地根目录**：`~/Documents/Agent/github 源码参考/30_多模态与媒体分析/20_vision_ocr_detection/PaddleOCR`
...
| `project_context` | **失败/不可用**：无法核对返回项目名和根目录；后续 codegraph 响应携带的项目根是 `~/Documents/Agent/PHP/华世王镞_v3`，与目标 PaddleOCR 根不匹配，已排除。 |
