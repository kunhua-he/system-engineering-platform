...
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/python-fne`
...
`~/Documents/Agent/github 源码参考/12_工作流编排/prefect`。
...
审计对象是只读参考目录：
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/espeechengine`。
...
研究对象为外部只读参考源码：
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/eword2000`。
...
研究对象是只读参考仓库：`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/vclbase`。当前 HEAD 为 `a0b89a1e8b5c0d38c4557a97fff468c3a2368763`（2022-12-19），远程为 `https://gitee.com/JYtechnology/vclbase.git`。本轮只修改本仓库根 `ARCHITECTURE.md`，不修改外部参考仓库。
...
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/exmlrpc`
...
研究对象为只读参考仓库：
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/evectoraframe`。
...
`~/Documents/Agent/源码研究工作区/opencode-最新版本`
...
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/eexcel2000`
...
目标是外部只读参考仓库：
`~/Documents/Agent/github 源码参考/30_多模态与媒体分析/55_knowledge_graph_rag/KAG`。
...
研究对象：`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/einterprocess`。
...
研究对象为本地只读参考源码：`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/wnet`。本节按 Windows network、HTTP/连接、认证、线程/超时、关闭/错误、句柄/释放、ABI、tests 和 docs 分段核对。外部参考目录没有 CodeGraph 索引，已尝试查询并收到 `no .codegraph/index`；以下事实来自当前磁盘源码和工程文件。
...
研究对象为仓库外只读参考项目：
`~/Documents/Agent/github 源码参考/90_历史与专项/易语言/源码仓库/公开仓库/Gitee_精易官方/emmedia`。
