...
def main(argv: list[str] | None = None) -> int:
    ...
    if 红项:
        ...
        return 1
    print("结论：绿 —— 五个检查器全部退出 0（新增违规 0；存量以各自基线为准）")
    return 0
