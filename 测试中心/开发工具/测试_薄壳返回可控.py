...
class 工具形状测试(unittest.TestCase):
    ...
    def test_调用腿只暴露三个入参(self):
        """腿 2（2026-09-25 定稿）：`能力id` ＋ `数组` ＋ `返回字符数`，一个不多。
        ...
        self.assertEqual(["能力id", "数组", "返回字符数"], list(属性),
                         "腿 2 的入参必须恰是这三件（多一件就是又长出一条旧腿）")
