...
运行库表定义 = {
    ...
    "检查点索引": {
        "字段": ["检查点id", "会话id", "版本", "路径", "摘要"],
        "索引": ["状态", "会话id", "版本", "创建时间"],
    },
    "会话": {
        "字段": ["会话id", "用户id", "模型名", "标题", "压缩次数", "成本统计", "最后消息时间"],
        "索引": ["状态", "用户id", "模型名", "更新时间"],
    },
    "缓存索引": {
        "字段": ["缓存键", "文本哈希", "模型名", "提供者", "路径", "摘要", "过期时间", "命中次数"],
        "索引": ["状态", "缓存键", "文本哈希", "模型名", "更新时间", "过期时间"],
    },
    "灰度观测": {
    ...
    "发布": {
        "字段": ["包id", "期望版本", "候选版本", "灰度比例", "激活指针", "回滚事务", "时间"],
        "索引": ["状态", "包id", "激活指针", "创建时间"],
    },
}
运行库主键字段 = {
    "任务": "任务id", "作业": "作业id", "协作状态": "work_id", "能力占用": "能力id",
    "检查点索引": "检查点id", "会话": "会话id", "缓存索引": "缓存键",
    "灰度观测": "观测id", "灰度状态": "键", "发布": "发布id",
}
